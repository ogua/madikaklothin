...
class BridalController extends AdminController
{
    /**
     ...
     protected function table()
    {
        ...
        $table->model()->where('measuretype','BridalsWear');
     ...
     protected function form()
    {
        ...
        $form->hidden('measurement.measuretype')->value('BridalsWear');
